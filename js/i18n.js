...
const I18N = {
  zh: {
    ...
    yt_formula: '说明：YT 净收益 = 空投价值 + UY 底息 - 买入成本（到期归零）；积分按 Season/到期较早日期估算，并已扣除 Pendle 5% 积分抽水。',
    yt_totalMiles: 'YT 至结束可获 Points',
    yt_airdropValue: 'YT 预估空投价值 & ROI',
    yt_airdrop: '空投',
    yt_netValue: 'YT 预估净收益',
    yt_baseYield: '底息',
    yt_maturityLoss: '到期归零',
    yt_noBaseYield: '无底息',
    ytNetRoiNote: '含底息与到期归零',
    yt_contribution: '贡献',
  ...
  en: {
    ...
    yt_formula: 'Note: YT net return = airdrop value + UY base yield - purchase cost (YT expires to zero). Points use the earlier of season end or YT expiry and already exclude Pendle\'s 5% points fee.',
    ...
    yt_maturityLoss: 'Expiry to zero',
    yt_noBaseYield: 'No base yield',
    ytNetRoiNote: 'Includes base yield and expiry to zero',
